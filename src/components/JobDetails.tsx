...
import { X, Save, Plus, Trash2, Clock, CheckCircle, Package, User, Hash, Archive, AlertCircle, FileText, Smartphone, Download } from 'lucide-react';
                            ...
                            <div className="px-4 py-3 md:px-6 md:py-4 border-b border-slate-800 flex items-start justify-between bg-slate-950">
                                ...
                                <div className="flex items-center gap-2 md:gap-3">
                                     ...
                                     <button
                                        ...
                                        style={{ '--hover-bg': '#25D366' } as React.CSSProperties}
